...
\addlinespace
\texttt{CLaMP1-ABC} & Velocity removed & 0.0166 & {0.67} & [0.020,\,0.036] & 0.06 \\
\texttt{CLaMP1-ABC} & Timing quantized & 0.0154 & {0.62} & [0.018,\,0.034] & 0.09 \\
\texttt{CLaMP1-ABC} & Tempo flattened & 0.0206 & {0.83} & [0.021,\,0.040] & 0.03 \\
\texttt{CLaMP1-ABC} & All combined & 0.0223 & {0.90} & [0.023,\,0.049] & $<$0.01 \\
\bottomrule
\end{tabular}
\end{table}
